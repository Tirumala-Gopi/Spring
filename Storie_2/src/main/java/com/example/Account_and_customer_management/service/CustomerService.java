...
import com.example.Account_and_customer_management.config.CustomerConfig;
...
public class CustomerService {
	...
	public Customer addCustomer(CustomerDto dto) {
		...
		if (geoResponse != null) {
			...
			customer.setCity(geoResponse.getStandard().getCity());
			customer.setProvince(geoResponse.getStandard().getProv());
		}
